...
void MyMD5Init(MD5_CTX *context)
{
     context->count[0] = 0;
     context->count[1] = 0;
...
void MyMD5Update(MD5_CTX *context,unsigned char *input,unsigned int inputlen)
{
...
void MyMD5Final(MD5_CTX *context,unsigned char digest[16])
{
